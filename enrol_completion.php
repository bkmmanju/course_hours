...
$PAGE->set_url($CFG->wwwroot . '/local/course_hours/enrol_completion.php');
$title = get_string('enrolandcompletion','local_course_hours');
...
$results = all_enroll_and_completion_data($startdate, $enddate);
$html =html_writer::start_div('container-fluid');
$html.=html_writer::start_div('row');
$html.=html_writer::start_div('col-md-12 p-2');
$html.=html_writer::start_tag('a',array('href'=>$CFG->wwwroot.'/local/course_hours/report.php'));
$html.=get_string('back','local_course_hours');
